    ...
    <main>
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <h1 className="text-4xl font-bold text-customblue mb-4">Standard téléphonique VoIP / Centrex</h1>
          <p className="text-gray-700 max-w-3xl">
            Standard virtuel, SVI, enregistrement d’appels, intégration softphone et QoS voix. Déploiement pour TPE/PME.
          </p>
        </div>
      </section>
          ...
          <ul className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
            {CITIES.map(c => (
              <li key={c.slug}>
                ...
                >
                  Standard téléphonique à {c.name}
                </Link>
              </li>
            ))}
          </ul>
